    ...
    unit_ai_definition() {
        return object({
            keys: {
                ...
                behaviors: array({
                    items: enumerate({
                        items: [
                            ...
                            'auto_capture_loot',
                            'auto_resolve_objective_based_structure',
                            /* */
                        ],
                    }),
                    isUnique: true,
                ...
                attack_target_type_range_scalar: float(),
                /* */
    ...
    unit_health_level_definition() {
        return object({
            keys: {
                ...
                credit_income_rate_per_population: float(),
                /* */
                    ...
                    items: object({
                        ...
                        keys: {
                            ...
                            unit_modifiers: object({
                                ...
                                keys: {
                                    additive_values: this.unit_health_level_definition(),
    ...
    create() {
        return schema({
            ...
            keys: {
                ...
                /* */
                /* game_version v1.41 */
                force_count_as_attackable_enemy_unit: boolean(),
                /* */
