    ...
    create() {
        return schema({
            keys: {
                ...
                planet_maintenance_costs_header: super.label_form(this.cache),
                ...
                simulation_asset_income_rate_scalar_line: super.label_form(this.cache),
                asset_tax_rate_line: super.label_form(this.cache),
                exotic_factory_count_line: super.label_form(this.cache),
                asset_total_rate_line: super.label_form(this.cache),
                researching_subjects_header: super.label_form(this.cache),
                ...
                exotic_count_line: super.label_form(this.cache),
                ...
                no_research_points_description: super.label_form2(this.cache),
                total_research_points_label_format: super.label_form2(this.cache),
                asset_delta_event_header_text: this.cache.localisation,
                asset_delta_event_alliance_offer_text: super.label_form2(this.cache),
                asset_delta_event_bounty_text: super.label_form2(this.cache),
                asset_delta_event_trade_ship_killed_text: super.label_form2(this.cache),
                asset_delta_event_synergy_ally_dead_text: super.label_form2(this.cache),
                asset_delta_event_losing_auction_refund_text: super.label_form2(this.cache),
                asset_delta_event_excavation_reward_text: super.label_form2(this.cache),
                ...
                research_rate_label: super.label_form2(this.cache),
                no_research_rate_description: super.label_form2(this.cache),
                no_research_rate_value_color: this.cache.colors,
            },
        })
    }
}
