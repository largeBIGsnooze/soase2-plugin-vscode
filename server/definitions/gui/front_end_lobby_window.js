            ...
            keys: {
                ...
                players_view_window: object({
                    keys: {
                        ...
                        team_count_drop_box: super.drop_box(this.cache.localisation, this.cache.colors),
                        ...
                        player_slot_window_definition: object({
                            keys: {
                                ...
                                drag_and_drop_hint_description: super.label_form2(this.cache.localisation, this.cache.colors),
                                ...
                                remove_player_button: object({
                                    keys: {
                                        ...
                                        ban_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                                    },
                                }),
                                slot_status_button: object({
                                    keys: {
                                        ...
                                        status_definitions: object({
                                            keys: {
                                                open: super.status_definition(this.cache.localisation, this.cache.textures),
                                                closed: super.status_definition(this.cache.localisation, this.cache.textures),
                                                human: super.status_definition(this.cache.localisation, this.cache.textures),
                                                ai: super.status_definition(this.cache.localisation, this.cache.textures),
                                            },
                                        }),
                                    },
                                }),
                                ...
                                ai_difficulty_button: super.button(this.cache.localisation, this.cache.textures, this.cache.colors),
                                ai_behavior_button: super.button(this.cache.localisation, this.cache.textures, this.cache.colors),
                            },
                        }),
                    },
                }),
                game_code_box: super.button(this.cache.localisation, this.cache.textures, this.cache.colors),
                ...
                start_game_button: super.button(this.cache.localisation, this.cache.textures, this.cache.colors),
                exit_lobby_button: super.button(this.cache.localisation, this.cache.textures, this.cache.colors),
                            ...
                            keys: {
                                ...
                                toggle_option_button_shared_definition: object({
                                    keys: {
                                        ...
                                        is_loading_saved_game_description: super.label_form2(this.cache.localisation, this.cache.colors),
                                    },
                                }),
                                float_option_button_shared_definition: object({
                                    keys: {
                                        ...
                                        restricted_description: super.label_form2(this.cache.localisation, this.cache.colors),
                                    },
                                }),
                                can_gravity_wells_move_button: object({
                                    keys: {
                                        ...
                                        description: this.cache.localisation,
                                        can_gravity_wells_move_not_allowed_by_scenario_description: super.label_form2(this.cache.localisation, this.cache.colors),
                                        tooltip: super.tooltip(this.cache.localisation, this.cache.textures, this.cache.colors),
                                    },
                                }),
                ...
                model: object({
                    keys: {
                        ai_difficulty_definitions: object({
                            keys: {
                                easy: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                medium: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                hard: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                unfair: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                nightmare: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                impossible: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                            },
                        }),
                        ai_behavior_definitions: object({
                            keys: {
                                aggressive: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                defensive: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                research: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                                economic: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                            },
                        }),
                        random_ai_behavior_definition: super.ai_dificulty_definition(this.cache.localisation, this.cache.textures),
                    },
                }),
            },
        })
