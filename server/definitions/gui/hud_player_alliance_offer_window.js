...
module.exports = class HudPlayerAllianceOfferWindow extends Definitions {
    ...
    planet_button_shared_definition() {
        return object({
            keys: {
                ...
                unconfirmed_planet_notification_line: super.label_form(this.cache),
    ...
    alliance_type_button_shared_definition() {
        return object({
            keys: {
                not_included_in_offer_alpha: float(),
                already_allied_line: super.label_form(this.cache),
                root_alliance_required_line: super.label_form(this.cache),
            },
        })
    }
    ...
    content_window() {
        return object({
            keys: {
                ...
                demand_label: super.label(this.cache),
                offer_label: super.label(this.cache),
                my_player_panel: {
                    player_theme_icon_window: super.label(this.cache),
                    player_name_label: super.label(this.cache),
                    portrait_window: super.portrait_window(),
                    credits_button: super.button(this.cache),
                    metal_button: super.button(this.cache),
                    crystal_button: super.button(this.cache),
                    planet_button_0: super.button(this.cache),
                    planet_button_1: super.button(this.cache),
                    planet_button_2: super.button(this.cache),
                ...
                cease_fire_button: super.button(this.cache),
                share_vision_button: super.button(this.cache),
                synergy_button: super.button(this.cache),
                ...
                ok_button: super.ok_button(this.cache),
                break_alliance_button: super.break_alliance_button(this.cache),
                chat_button: super.button(this.cache),
            },
        })
    }
