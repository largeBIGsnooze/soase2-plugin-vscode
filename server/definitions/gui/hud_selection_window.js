                    ...
                    keys: {
                        ...
                        unit_window: object({
                            keys: {
                                ...
                                toggle_should_stack_unit_input_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                                right_click_attack_all_input_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                                select_all_of_same_type_of_unit_input_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                            },
                        }),
