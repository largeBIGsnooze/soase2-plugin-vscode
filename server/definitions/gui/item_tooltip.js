    ...
    create() {
        return schema({
            keys: {
                ...
                waiting_for_item_owner_unit_to_be_built_line: super.label_form(this.cache),
                waiting_for_available_item_slot_to_build_line: super.label_form(this.cache),
                waiting_for_out_of_combat_line: super.label_form(this.cache),
                missing_ship_component_shop_line: super.label_form(this.cache),
                missing_ship_component_shop_scalar_value_label: this.cache.localisation,
                waiting_for_planet_level_line: super.label_form(this.cache),
                finite_item_quantity_line: super.label_form(this.cache),
                ...
                change_garrison_orders_line: super.label_form(this.cache),
                drag_and_drop_to_remove_line: super.label_form(this.cache),
                is_ruler_ship_label: super.label_form2(this.cache),
                is_ruler_ship_description: super.label_form2(this.cache),
                is_phase_resonance_capacitor_label: super.label_form2(this.cache),
                is_phase_resonance_capacitor_description: super.label_form2(this.cache),
                phase_resonance_capacitor_progress_line: super.label_form(this.cache),
            },
        })
    }
}
