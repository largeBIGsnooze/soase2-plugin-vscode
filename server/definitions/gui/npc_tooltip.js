    ...
    create() {
        return schema({
            keys: {
                ...
                auction_rewards_header_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                active_auction_bid_amount_label: this.cache.localisation,
                active_auction_last_result_header: this.cache.localisation,
                active_auction_bidder_count_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                auction_lost_refund_percentage_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                ...
                is_dead_line: this.label_form2(this.cache.localisation, this.cache.colors),
                ...
                culture_reward_never_available_line: super.label_form2(this.cache.localisation, this.cache.colors),
                time_until_next_culture_reward_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                raid_reward_supply_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                raid_reward_bounty_credits_label: this.cache.localisation,
                market_exclusive_use_duration_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                market_exclusive_player_remaining_duration_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
