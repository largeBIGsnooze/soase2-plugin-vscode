    ...
    create() {
        return schema({
            keys: {
                ...
                acquire_tier_time: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                acquired_tier_label: super.label_form2(this.cache.localisation, this.cache.colors),
                acquiring_tier_percentage: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                research_time: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                researching_percentage: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                research_completed: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                ...
                modified_units_header: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                ...
                simulation_research_rate_scalar_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                waiting_for_future_research_prerequisites_met_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                waiting_for_future_required_research_tier_met_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                ...
                planet_track_level_culture_provider_track_type_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                planet_track_level_culture_provider_minimum_level_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                planet_track_level_culture_provider_culture_rate_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                max_supply_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                unit_starting_experience_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                culture_propagation_rate_scalar_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                culture_propagation_rate_scalar_description: super.label_form2(this.cache.localisation, this.cache.colors),
                structure_slots_required_line: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
                ...
                windfall_header_label: super.label_form(this.cache.localisation, this.cache.colors, this.cache.textures),
